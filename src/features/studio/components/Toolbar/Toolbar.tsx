...
export function Toolbar() {
  ...
  const aiDismissTimer = useRef<ReturnType<typeof setTimeout> | undefined>(undefined)
  ...
  return (
    <header className={styles.toolbar}>
      {/* Traffic lights are provided by the host macOS-shell window chrome
          (RobloxStudioWindow). The Studio's original toolbar shipped fake
          traffic lights here; now that we're embedded inside a real window,
          rendering them again duplicated the chrome. */}
